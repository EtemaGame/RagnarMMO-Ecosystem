...
public final class CoreDerivedStatsCalculator {
    ...
    public static DerivedStats compute(ServerPlayer player, IPlayerStats stats) {
        ...
        applyDefense(derived, vit, agi, intel, level);
    ...
    private static void applyDefense(DerivedStats derived, int vit, int agi, int intel, int level) {
