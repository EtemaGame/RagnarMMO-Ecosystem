...
public final class SocialHudOverlay {
    ...
    public static final IGuiOverlay INSTANCE = SocialHudOverlay::render;

    private SocialHudOverlay() {
    }
    ...
    private static void render(ForgeGui gui, GuiGraphics graphics, float partialTick, int screenWidth, int screenHeight) {
        ...
        if (!ModList.get().isLoaded(SOCIAL_MOD_ID) || !PartyClientData.hasParty()) {
            return;
        }
