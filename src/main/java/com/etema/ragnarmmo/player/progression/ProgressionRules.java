...
public record ProgressionRules(
    ...
    public static ProgressionRules currentFromConfig(ResourceLocation jobId) {
        ...
        return new ProgressionRules(
                novice ? RagnarCoreConfigs.SERVER.caps.noviceMaxLevel.get() : RagnarCoreConfigs.SERVER.caps.maxLevel.get(),
                novice ? RagnarCoreConfigs.SERVER.caps.noviceMaxJobLevel.get() : RagnarCoreConfigs.SERVER.caps.maxJobLevel.get(),
                RagnarCoreConfigs.SERVER.progression.baseStatPoints.get(),
                RagnarCoreConfigs.SERVER.progression.pointsPerLevel.get(),
                RagnarCoreConfigs.SERVER.progression.usePreRenewalStatPointCurve.get(),
                RagnarCoreConfigs.SERVER.progression.expGlobalMultiplier.get(),
                RagnarCoreConfigs.SERVER.progression.jobExpGlobalMultiplier.get(),
                RagnarCoreConfigs.SERVER.progression.baseExpDeathPenaltyRate.get(),
                RagnarCoreConfigs.SERVER.progression.jobExpDeathPenaltyRate.get(),
