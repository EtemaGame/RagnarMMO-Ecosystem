...
public final class SkillCombatSpecResolver {
    ...
    public static Optional<SkillCombatSpec> resolve(ISkillDefinition definition, int level) {
        ...
        return Optional.of(new SkillCombatSpec(damageType, element, hitPolicy, damagePercent, hitCount, aoeRadius,
                splashRatio, accuracyBonus, defenseBypassPercent, flatDamageBonus));
    }
    ...
    public static boolean isMigratedCombatSkill(ResourceLocation id) {
        ...
        return switch (id.getPath()) {
            case "arrow_shower", "bash", "blast_mine", "blitz_beat", "bowling_bash", "brandish_spear",
                    ...
                    "fire_ball", "fire_bolt", "fire_pillar", "fire_wall", "frost_diver", "grimtooth",
                    "heavens_drive", "land_mine", "magnum_break", "magic_crasher",
                    ...
                    "spear_stab", "storm_gust", "lightning_bolt", "thunder_storm", "turn_undead",
    ...
    private static RagnarDamageType defaultDamageType(String skillPath) {
        return switch (skillPath) {
            case "cold_bolt", "fire_ball", "fire_bolt", "fire_pillar", "fire_wall", "frost_diver",
                    "heavens_drive", "lord_of_vermilion", "magic_crasher",
                    "magnus_exorcismus", "meteor_storm", "napalm_beat", "ruwach",
                    "sightrasher", "soul_strike", "storm_gust", "lightning_bolt", "thunder_storm",
    ...
    private static ElementType defaultElement(String skillPath) {
        return switch (skillPath) {
            case "blast_mine", "claymore_trap", "fire_ball", "fire_bolt", "fire_pillar", "fire_wall", "magnum_break", "meteor_storm", "sightrasher" -> ElementType.FIRE;
