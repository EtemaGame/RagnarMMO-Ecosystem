...
public class LifeSkillClientHandler {
    ...
    public static void syncAll(CompoundTag data) {
        net.minecraft.client.Minecraft mc = net.minecraft.client.Minecraft.getInstance();
        if (mc.player != null) {
            LifeSkillCapability.get(mc.player)
                    .ifPresent(manager -> manager.deserializeNBT(data));
        }
    }

    public static void updateSkill(LifeSkillType skill, int level, int points) {
        net.minecraft.client.Minecraft mc = net.minecraft.client.Minecraft.getInstance();
        if (mc.player != null) {
